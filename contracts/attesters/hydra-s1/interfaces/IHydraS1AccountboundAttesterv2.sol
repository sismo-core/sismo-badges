 ...
 * @author Sismo
 * @notice Interface of the HydraS1AccountboundAttesterv2 contract which inherits from the errors, events and methods specific to the HydraS1SimpleAttester interface.
 **/
